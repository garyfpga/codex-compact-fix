...
- Recovery build: after post-release fixes on `254267491995a7c05b03ee9319a2e40e593866b6`, `cd codex-rs && just fmt` completed successfully, then `CODEX_CLI_RELEASE_VERSION="0.141.c7329.1.mod" cargo build -p codex-cli --release` completed successfully in 9m 06s. Tests remained not run; Bazel remained unused.
- Recovery artifact verification: repository-root `codex` replaced via temp-file plus atomic rename after direct overwrite hit `Text file busy`; source `codex-rs/target/release/codex` and repo-root `codex` both size `1241523672`, mode `-rwxr-xr-x`, SHA-256 `15e38176234c819066a7ea3412e1e20e0cf923f5484e59bb9a4d0ada8558d40e`; `./codex --version` printed `codex-cli 0.141.c7329.1.mod`. Build verifier: PASS.
- Recovery publish packaging reviewer: PASS.
- Recovery publish: by explicit user direction, deleted the earlier `0.141.c7329.1.mod` GitHub release and tag, recreated the annotated tag `0.141.c7329.1.mod` on `254267491995a7c05b03ee9319a2e40e593866b6`, pushed it to `origin`, and recreated the GitHub release at `https://github.com/garyfpga/codex-compact-fix/releases/tag/0.141.c7329.1.mod` with artifact `codex` (asset SHA-256 `15e38176234c819066a7ea3412e1e20e0cf923f5484e59bb9a4d0ada8558d40e`).
