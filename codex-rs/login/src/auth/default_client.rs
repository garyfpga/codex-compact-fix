...
/// Builds the default Codex reqwest client for a concrete outbound route with
/// compact-specific TCP keepalive settings.
pub fn build_default_reqwest_client_for_route_with_tcp_keepalive_interval(
    http_client_factory: &HttpClientFactory,
    request_url: &str,
    route_class: ClientRouteClass,
    ...
    http_client_factory.build_reqwest_client(builder, request_url, route_class)
}
