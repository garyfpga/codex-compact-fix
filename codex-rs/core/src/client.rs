...
use codex_login::default_client::build_default_reqwest_client_for_route_with_tcp_keepalive_interval;
...
impl ModelClient {
    ...
    pub(crate) async fn compact_conversation_history(
        ...
        let compact_http_client =
            build_default_reqwest_client_for_route_with_tcp_keepalive_interval(
        ...
        let transport = ReqwestTransport::new(compact_http_client);
